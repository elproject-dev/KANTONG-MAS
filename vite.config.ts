...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@workspace/api-client-react": path.resolve(import.meta.dirname, "src/mocks/api-client-react.ts"),
      "stream": path.resolve(import.meta.dirname, "src/mocks/stream-mock.js"),
    },
