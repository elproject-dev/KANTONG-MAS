...
async function runRelease() {
  try {
    console.log('🚀 Memulai proses rilis Android...\n');
    ...
    const fileName = `KantongMas_v.${version}.apk`;
    ...
    console.log('\n🎉 Rilis Android Sukses! Pengguna sekarang akan mendapatkan popup update.');
